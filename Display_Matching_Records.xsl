			...
			<xsl:when test="$VehClaimRecord = 'E' or $VehClaimRecord = 'A' or $VehClaimRecord = 'V'">
				...
				<xsl:if test="count($InsPhone1) &gt; 0">
					<xsl:call-template name="Insert_Data">
						...
						<xsl:with-param name="Data_Value">
							<xsl:number value="substring($InsPhone1,4,3)" format="(001"/>
							<xsl:number value="substring($InsPhone1,8,3)" format=") 001-"/>
							<xsl:number value="substring($InsPhone1,11,4)" format="0001"/>
						</xsl:with-param>
					</xsl:call-template>
				</xsl:if>
			...
			-->
				...
				<xsl:call-template name="Insert_Data">
					...
					<xsl:with-param name="Data_Value">
						...
						<xsl:if test="$RenewalInd=0 or $RenewalInd='N'">NO</xsl:if>
						<xsl:if test="$RenewalInd=1 or $RenewalInd='Y'">YES</xsl:if>
					</xsl:with-param>
				</xsl:call-template>
				...
				<xsl:call-template name="Insert_Data">
					...
					<xsl:with-param name="Data_Value">
						...
						<xsl:if test="$AssignRisk=0 or $AssignRisk='N'">NO</xsl:if>
						<xsl:if test="$AssignRisk=1 or $AssignRisk='Y'">YES</xsl:if>
					</xsl:with-param>
				</xsl:call-template>
				<xsl:variable name="SplitZip" select="Policy/MiscParty[MiscPartyInfo/MiscPartyRoleCd= 'CarrierInsurer']/GeneralPartyInfo/Addr/PostalCode"/>
				...
				<xsl:if test="count($InsPhone) &gt; 0">
					<xsl:call-template name="Insert_Data">
						...
						<xsl:with-param name="Data_Value">
							...
							<xsl:number value="substring($InsPhone,4,3)" format="(001"/>
							<xsl:number value="substring($InsPhone,8,3)" format=") 001-"/>
							<xsl:number value="substring($InsPhone,11,4)" format="0001"/>
						</xsl:with-param>
					</xsl:call-template>
				</xsl:if>
...
*********************************************************************************
-->
	<xsl:template name="Display_Matching_Legacy_Salvage">
		...
		<xsl:param name="InvestigationNode"/>
			...
			<xsl:call-template name="Insert_Data">
				...
				<xsl:variable name="MV09SalDt" select="SalvageDt"/>
				...
				<xsl:call-template name="Insert_Data">
					...
					<xsl:with-param name="Data_Value">
						<xsl:value-of select="ItemValuePriorToLossAmt/Amt"/>
					</xsl:with-param>
				</xsl:call-template>
				<xsl:call-template name="Insert_Data">
					<xsl:with-param name="Data_Name">Value Received</xsl:with-param>
					<xsl:with-param name="Data_Value">
						<xsl:value-of select="ItemValueReceivedAmt/Amt"/>
					</xsl:with-param>
				</xsl:call-template>
				<xsl:call-template name="Insert_Data">
					<xsl:with-param name="Data_Name">Appraised Value</xsl:with-param>
					<xsl:with-param name="Data_Value">
						<xsl:value-of select="ItemAppraisedValueAmt/Amt"/>
					</xsl:with-param>
				</xsl:call-template>
				<xsl:variable name="OwnerRetainSal" select="OwnerRetainingSalvageInd"/>
				<xsl:call-template name="Insert_Data">
				...
				<xsl:if test="string-length(normalize-space($BuyerNode)) &gt; 0">
					...
					<xsl:if test="count($Veh_BusinessNum) &gt; 0">
						<xsl:call-template name="Insert_Data">
							<xsl:with-param name="Data_Name">Business Phone</xsl:with-param>
							<xsl:with-param name="Data_Value">
								<xsl:number value="substring($Veh_BusinessNum,4,3)" format="(001"/>
								<xsl:number value="substring($Veh_BusinessNum,8,3)" format=") 001-"/>
								<xsl:number value="substring($Veh_BusinessNum,11,4)" format="0001"/>
							</xsl:with-param>
						</xsl:call-template>
					</xsl:if>
				</xsl:if>
	...
	<xsl:template name="Display_Matching_Alias">
		...
		<xsl:if test="count($AKA_Business_Num) &gt; 0">
			<xsl:call-template name="Insert_Data_And_Check_For_More_Matches">
				...
				<xsl:with-param name="Data_Value">
					<!--<xsl:value-of select="GeneralPartyInfo/Communications/PhoneInfo[PhoneTypeCd = 'Phone' and CommunicationUseCd = 'Business']/PhoneNumber"/>-->
					<xsl:number value="substring($AKA_Business_Num,4,3)" format="(001"/>
					<xsl:number value="substring($AKA_Business_Num,8,3)" format=") 001-"/>
					<xsl:number value="substring($AKA_Business_Num,11,4)" format="0001"/>
				</xsl:with-param>
				<xsl:with-param name="Data_Value_ID">
					<xsl:value-of select="GeneralPartyInfo/Communications/PhoneInfo[PhoneTypeCd = 'Phone' and CommunicationUseCd = 'Business']/PhoneNumber/@id"/>
				</xsl:with-param>
	...
	<xsl:template name="Display_Matching_Casualty_Info">
		...
		<xsl:call-template name="Insert_Data">
			...
			<xsl:with-param name="Data_Value">
				...
				<xsl:if test="$MC02SuitInd=0 or $MC02SuitInd='N'">NO</xsl:if>
				<xsl:if test="$MC02SuitInd=1 or $MC02SuitInd='Y'">YES</xsl:if>
			</xsl:with-param>
		</xsl:call-template>
		<xsl:variable name="MC02EstLoss" select="$ClaimRoot/ClaimsOccurrence/ProbableIncurredAmt[contains(@idref,$MC01Id)]/Amt"/>
	...
	<xsl:template name="Display_Matching_Property_Info">
		...
		<xsl:if test="count($Adj_PhoneNum) &gt; 0">
			<xsl:call-template name="Insert_Adjuster">
				<xsl:with-param name="AdjusterPhone">
					<!--<xsl:value-of select="$AdjusterNode/../GeneralPartyInfo/Communications/PhoneInfo/PhoneNumber"/>-->
					<xsl:number value="substring($Adj_PhoneNum,4,3)" format="(001"/>
					<xsl:number value="substring($Adj_PhoneNum,8,3)" format=") 001-"/>
					<xsl:number value="substring($Adj_PhoneNum,11,4)" format="0001"/>
				</xsl:with-param>
			</xsl:call-template>
		</xsl:if>
		<xsl:call-template name="Insert_Data">
	...
	<xsl:template name="Display_Matching_Boat_Mobile_Property">
		...
		<xsl:if test="count($Boat_PhoneNum) &gt; 0">
			<xsl:call-template name="Insert_Adjuster">
				<xsl:with-param name="AdjusterPhone">
					<!--<xsl:value-of select="$AdjusterNode/../GeneralPartyInfo/Communications/PhoneInfo/PhoneNumber"/>-->
					<xsl:number value="substring($Boat_PhoneNum,4,3)" format="(001"/>
					<xsl:number value="substring($Boat_PhoneNum,8,3)" format=") 001-"/>
					<xsl:number value="substring($Boat_PhoneNum,11,4)" format="0001"/>
				</xsl:with-param>
			</xsl:call-template>
		</xsl:if>
		<xsl:variable name="SuiteInd" select="$ClaimsPartyNode/ClaimsPartyInfo/SuitFiledInd"/>
		...
		<!-- GAURAV : Added to Insert More Matches-->
		<xsl:if test="$ClaimRoot/../MatchInfo/AdditionalMatchInfo/@idref = PropLossNode/ItemInfo/ItemDefinition[ItemTypeCd = 'MoblEquip']/SerialIdNumber/id">
			<xsl:call-template name="Insert_More_Matches">
				<xsl:with-param name="Match_Desc">
					<xsl:value-of select="'VIN'"/>
				</xsl:with-param>
...
-->
	<xsl:template name="Display_Matching_Vehicle_Info">
		...
		<xsl:if test="$ClaimRoot/../MatchInfo/AdditionalMatchInfo/@idref = $VehLossNode/VehInfo/VehIdentificationNumber/@id">
			<xsl:call-template name="Insert_More_Matches">
				<xsl:with-param name="Match_Desc">
					<xsl:value-of select="'VIN'"/>
				</xsl:with-param>
		...
		<xsl:variable name="MV02EstLoss" select="$ClaimRoot/ClaimsOccurrence/ProbableIncurredAmt[contains(@idref,$MV01Id)]/Amt"/>
		<!--GAURAV : Updated Est. Loss Amt for idref. -->
...
-->
	<xsl:template name="Display_Matching_Vehicle_Recovery">
		...
		<xsl:value-of select="$InvestigationNode/@id"/>
			...
			<xsl:if test="count($Veh_ContactNum) &gt; 0">
				<xsl:call-template name="Insert_Data">
					...
					<xsl:with-param name="Data_Value">
						...
						<xsl:number value="substring($Veh_ContactNum,4,3)" format="(001"/>
						<xsl:number value="substring($Veh_ContactNum,8,3)" format=") 001-"/>
						<xsl:number value="substring($Veh_ContactNum,11,4)" format="0001"/>
					</xsl:with-param>
				</xsl:call-template>
			</xsl:if>
			<xsl:call-template name="Insert_Data">
...
-->
	<xsl:template name="Display_Matching_Vehicle_Salvage">
		...
		<xsl:variable name="Legacysal" select="substring($ClaimRoot/ClaimsOccurrence/ItemIdInfo/AgencyId,1,3)"/>
		<xsl:value-of select="ClaimsOccurrence/ItemIdInfo/AgencyId"/>
		<xsl:if test="not(contains($Legacysal, 'S0'))">
			...
			-->
				...
				<xsl:call-template name="Insert_Data">
					<xsl:with-param name="Data_Name">VIN Missing Indicator</xsl:with-param>
					<xsl:with-param name="Data_Value">
						<xsl:value-of select="$BuyerNode/VINMissingInd"/>
					</xsl:with-param>
				</xsl:call-template>
				<xsl:call-template name="Insert_Data">
					<xsl:with-param name="Data_Name">Engine Missing Indicator</xsl:with-param>
