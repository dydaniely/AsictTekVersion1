	...
	<xsl:template name="Display_General_Info">
		...
		<xsl:call-template name="Insert_Data">
			...
			<xsl:with-param name="Data_Value">
				...
				<xsl:if test="$RenewInd =0 or $RenewInd ='N'">NO</xsl:if>
				<xsl:if test="$RenewInd =1 or $RenewInd ='Y'">YES</xsl:if>
			</xsl:with-param>
		</xsl:call-template>
		...
		<xsl:call-template name="Insert_Data">
			...
			<xsl:with-param name="Data_Value">
				...
				<xsl:if test="$AssignedRisk=0 or $AssignedRisk='N'">NO</xsl:if>
				<xsl:if test="$AssignedRisk=1 or $AssignedRisk='Y'">YES</xsl:if>
			</xsl:with-param>
		</xsl:call-template>
		...
		<xsl:if test="count($CAT) &gt;0">
			...
			<b>
				...
				<td align="left">
					<font size="2" face="Arial">
						<xsl:if test="$CAT=0 or $CAT='N'">NO</xsl:if>
						<xsl:if test="$CAT=1 or $CAT='Y'">YES</xsl:if>
					</font>
		...
		<xsl:call-template name="Insert_Data">
			...
			<xsl:with-param name="Data_Value">
				...
				<xsl:if test="$FundInd=0 or $FundInd='N'">NO</xsl:if>
				<xsl:if test="$FundInd=1 or $FundInd='Y'">YES</xsl:if>
			</xsl:with-param>
		</xsl:call-template>
		<xsl:call-template name="Insert_Data">
		...
		<xsl:variable name="HitRunInd" select="ClaimsOccurrence/com.iso_HitAndRunInd"/>
		<xsl:call-template name="Insert_Data">
			<xsl:with-param name="Data_Name">Hit &amp; Run Accident</xsl:with-param>
			<xsl:with-param name="Data_Value">
				<xsl:if test="$HitRunInd='N'">NO</xsl:if>
				<xsl:if test="$HitRunInd='Y'">YES</xsl:if>
			</xsl:with-param>
		</xsl:call-template>
				...
				<tr>
					<td>
						<table width="650" border="1" cellpadding="3" cellspacing="0" style="border: 1px solid #d0d0d0;">
							<tr>
								<td colspan="11">
									<img src="cs_headlines.gif" width="659" height="140"/>
								</td>
							</tr>
							<tr>
				...
				<td>
					<xsl:if test="count($SumHeader3) &gt; 0 or count($KeyHeader3) &gt; 0">
						<table width="650" border="1" cellpadding="3" cellspacing="0" style="border: 1px solid #d0d0d0;">
							<tr>
								<td colspan="11">
									<img src="cs_headlines.gif" width="650" height="140"/>
								</td>
							</tr>
							<tr>
								<td width="140" align="center">
...
-->
	<xsl:template name="Display_Involved_Party">
		...
		<!--<xsl:variable name="SIUInvolvedPartyId" select="../com.iso_SIUParty/@ClaimsPartyRef"/>-->
		<!--../com.iso_SIUParty[@ClaimsPartyRef = $CPId]/Communications/EmailInfo/EmailAddr-->
		<xsl:if test="../com.iso_SIUParty[@ClaimsPartyRef = $CPId]/Communications/EmailInfo/EmailAddr">
			<xsl:call-template name="Insert_Data">
				<xsl:with-param name="Data_Name">E-Mail Address</xsl:with-param>
				<xsl:with-param name="Data_Value">
					<!--<xsl:value-of select="GeneralPartyInfo/Communications/EmailInfo/EmailAddr"/>-->
					<xsl:value-of select="../com.iso_SIUParty[@ClaimsPartyRef = $CPId]/Communications/EmailInfo/EmailAddr"/>
				</xsl:with-param>
			</xsl:call-template>
		</xsl:if>
...
-->
	<xsl:template name="Display_Alias">
		...
		-->
		<xsl:variable name="AKA_DriverLicNum" select="ClaimsDriverInfo/DriversLicense/DriversLicenseNumber"/>
		<xsl:variable name="AKA_DriverSt" select="ClaimsDriverInfo/DriversLicense/StateProvCd"/>
		<xsl:if test="count($AKA_DriverLicNum) &gt; 0">
			<tr>
				<td align="left" colspan="1">&#160;&#160;
					<b>
						<font size="2" face="Arial">
				...
				<td align="left" colspan="1">
					<font size="2" face="Arial">
						<xsl:value-of select="$AKA_DriverLicNum"/>
					</font>
					<xsl:if test="count($AKA_DriverSt) &gt; 0">
						<b>
							<font size="2" face="Arial">
						&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;
						&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;State:
						...
						<font size="2" face="Arial">
							<xsl:value-of select="$AKA_DriverSt"/>
						</font>
					</xsl:if>
				</td>
			</tr>
		...
		<xsl:variable name="AKAEmailAddr" select="GeneralPartyInfo/Communications/EmailInfo/EmailAddr"/>
		<xsl:if test="count($AKAEmailAddr) &gt;0">
			<xsl:call-template name="Insert_Data">
				<xsl:with-param name="Data_Name">E-Mail Address</xsl:with-param>
				<xsl:with-param name="Data_Value">
					<xsl:value-of select="$AKAEmailAddr"/>
				</xsl:with-param>
			</xsl:call-template>
		</xsl:if>
...
-->
	<xsl:template name="Display_Service_Provider">
		...
		<!--<xsl:variable name="SPEmailAddr" select="GeneralPartyInfo/Communications/EmailInfo/EmailAddr"/>-->
		<xsl:variable name="SPEmailAddr" select="../com.iso_SIUParty[@ClaimsParty2Ref = $CPId]/Communications/EmailInfo/EmailAddr"/>
		<xsl:if test="count($SPEmailAddr) &gt;0">
			<xsl:call-template name="Insert_Data">
				<xsl:with-param name="Data_Name">E-Mail Address</xsl:with-param>
				<xsl:with-param name="Data_Value">
					<xsl:value-of select="$SPEmailAddr"/>
				</xsl:with-param>
			</xsl:call-template>
		</xsl:if>
		...
		<xsl:variable name="Doc1stVisitDt" select="PersonInfo/com.iso_1stDoctorDt"/>
		<xsl:if test="count($Doc1stVisitDt) &gt; 0">
			<xsl:call-template name="Insert_Data">
				<xsl:with-param name="Data_Name">Date of First Visit to this Doctor</xsl:with-param>
				<xsl:with-param name="Data_Value">
					<xsl:number value="substring($Doc1stVisitDt,6,2)" format="01/"/>
					<xsl:number value="substring($Doc1stVisitDt,9,2)" format="01/"/>
					<xsl:number value="substring($Doc1stVisitDt,1,4)" format="0001"/>
				</xsl:with-param>
			</xsl:call-template>
		</xsl:if>
...
-->
	<xsl:template name="Display_Casualy_Info">
		...
		-->
		<xsl:variable name="ICD9Cd" select="$ClaimRoot/com.iso_AddCovInfo/com.iso_CovInfo1[@itemRef= $InjInfoId]/ICDDiagnosticCd"/>
		<xsl:variable name="ICD9Causeofinjury" select="$ClaimRoot/com.iso_AddCovInfo/com.iso_CovInfo1[@itemRef=$InjInfoId]/com.iso_CauseofInjuryCd"/>
		<xsl:if test="count($ICD9Cd) &gt; 0 or count($ICD9Causeofinjury) &gt;0">
			<tr>
				<td align="left" nowrap="nowrap">
				&#160;&#160;
			...
			<xsl:if test="count($ICD9Cd) &gt; 0">
				<tr>
					...
					&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;
						<font size="2" face="Arial">
							<b>
								<xsl:value-of select="'Diagnosis Code'"/>:</b>
							<br/>
						</font>
					</td>
					<td align="left" nowrap="nowrap">
			...
			<xsl:if test="count($ICD9Causeofinjury) &gt;0">
				<!-- ICD10 Cause of Injury-->
				<xsl:call-template name="Insert_Data">
					<xsl:with-param name="Data_Name">&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;
		Cause Of Injury</xsl:with-param>
					<xsl:with-param name="Data_Value">
		...
		<!-- ICD10 codes-->
		<!--
		<xsl:variable name="ICD10Cd" select="$ClaimRoot/com.iso_AddCovInfo/com.iso_CovInfo1[@itemRef= $InjInfoId]/com.iso_ICD10Cd"/>
		<xsl:if test="count($ICD10Cd) &gt; 0">
			<tr>
				<td align="left" nowrap="nowrap">
				&#160;&#160;
				...
				<td align="left" nowrap="nowrap">
					<font size="2" face="Arial">
						...
						<xsl:for-each select="$ClaimRoot/com.iso_AddCovInfo/com.iso_CovInfo1[@itemRef=$InjInfoId]/com.iso_ICD10Cd">
							<xsl:value-of select="."/>
							<br/>
						</xsl:for-each>
					</font>
		...
		<xsl:variable name="ICD10Cd" select="$ClaimRoot/com.iso_AddCovInfo/com.iso_CovInfo1[@itemRef= $InjInfoId]/com.iso_ICD10Cd"/>
		<xsl:variable name="ICD10Causeofinjury" select="$ClaimRoot/com.iso_AddCovInfo/com.iso_CovInfo2[@itemRef=$InjInfoId]/com.iso_ICD10CauseOfInjuryCd"/>
		<xsl:if test="count($ICD10Cd) &gt; 0 or count($ICD10Causeofinjury) &gt;0">
			<tr>
				<td align="left" nowrap="nowrap">
				&#160;&#160;
			...
			<xsl:if test="count($ICD10Causeofinjury) &gt;0">
				<!-- ICD10 Cause of Injury-->
				<xsl:call-template name="Insert_Data">
					<xsl:with-param name="Data_Name">&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;
		Cause Of Injury</xsl:with-param>
					<xsl:with-param name="Data_Value">
						<xsl:value-of select="$ClaimRoot/com.iso_AddCovInfo/com.iso_CovInfo2[@itemRef=$InjInfoId]/com.iso_ICD10CauseOfInjuryCd"/>
					</xsl:with-param>
				</xsl:call-template>
			</xsl:if>
		</xsl:if>
		...
		<xsl:call-template name="Insert_Data">
			...
			<xsl:with-param name="Data_Value">
				...
				<xsl:if test="$MC01SuitInd=0 or $MC01SuitInd='N'">NO</xsl:if>
				<xsl:if test="$MC01SuitInd=1 or $MC01SuitInd='Y'">YES</xsl:if>
			</xsl:with-param>
		</xsl:call-template>
		...
		<xsl:if test="count($CMSTPOCDt) &gt;0 or count($CMSTPOCAmt) &gt;0 or count($CMSTPOCStartDt) &gt;0">
			...
			<xsl:for-each select="$CMSTPOC/com.iso_TPOCDt">
				...
				<tr>
					<xsl:if test="string-length(normalize-space($CMSTPOC/com.iso_TPOCDt[@id=$TPOCid])) &gt;0 or string-length(normalize-space($CMSTPOC/com.iso_TPOCAmt[@id=$TPOCid])) &gt;0">
						<xsl:if test="string-length(normalize-space($CMSTPOC/com.iso_TPOCDt[@id=$TPOCid])) &gt;0">
							<td align="left" nowrap="nowrap">&#160;&#160;&#160;
									<b>
									<font size="2" face="Arial">
										 the Claimant(TPOC) Date<xsl:value-of select="$TPOCid"/>:
										</font>
								</b>
							</td>
						</xsl:if>
						<td align="left">
							...
							<xsl:if test="string-length(normalize-space($CMSTPOC/com.iso_TPOCAmt[@id=$TPOCid])) &gt;0">
								...
								<b>
									...
									&#160;&#160;&#160;<xsl:if test="string-length(normalize-space($CMSTPOC/com.iso_TPOCDt[@id=$TPOCid])) &gt;0">&#160;&#160;&#160;
&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;</xsl:if>
TPOC Amount<xsl:value-of select="$TPOCid"/>:&#160;
									</font>
								</b>
					...
					<xsl:if test="string-length(normalize-space($CMSTPOC/com.iso_TPOCStartDt[@id=$TPOCid])) &gt;0">
						<tr>
							<td align="left">&#160;&#160;&#160;
									<b>
									<font size="2" face="Arial">
									TPOC Start Date<xsl:value-of select="$TPOCid"/>:
										</font>
								</b>
							</td>
							<td align="left">
	...
	<xsl:template name="Display_Property">
		...
		<xsl:call-template name="Insert_Data">
			...
			<xsl:with-param name="Data_Value">
				...
				<xsl:if test="$SuitInd=0 or $SuitInd='N'">NO</xsl:if>
				<xsl:if test="$SuitInd=1 or $SuitInd='Y'">YES</xsl:if>
			</xsl:with-param>
		</xsl:call-template>
			...
			<xsl:choose>
				<xsl:when test="ItemDefinition/ItemTypeCd[. = 'AudioVisual']">
					<xsl:call-template name="Insert_PropLost">
						...
						<xsl:with-param name="Display_Value">
							<xsl:value-of select="ItemDefinition/ItemTypeCd[. = 'AudioVisual']"/>
							<xsl:value-of select="IsSummaryInd"/>
						</xsl:with-param>
					</xsl:call-template>
				</xsl:when>
				<xsl:when test="ItemDefinition/ItemTypeCd[. = 'Art']">
					<xsl:call-template name="Insert_PropLost">
						...
						<xsl:with-param name="Display_Value">
							<xsl:value-of select="ItemDefinition/ItemTypeCd[. = 'Art']"/>
							<xsl:value-of select="IsSummaryInd"/>
						</xsl:with-param>
					</xsl:call-template>
				</xsl:when>
				<xsl:when test="ItemDefinition/ItemTypeCd[. = 'Cash']">
					<xsl:call-template name="Insert_PropLost">
						...
						<xsl:with-param name="Display_Value">
							<xsl:value-of select="ItemDefinition/ItemTypeCd[. = 'Cash']"/>
							<xsl:value-of select="IsSummaryInd"/>
						</xsl:with-param>
					</xsl:call-template>
				</xsl:when>
				<xsl:when test="ItemDefinition/ItemTypeCd[. = 'Clothing']">
					<xsl:call-template name="Insert_PropLost">
						...
						<xsl:with-param name="Display_Value">
							<xsl:value-of select="ItemDefinition/ItemTypeCd[. = 'Clothing']"/>
							<xsl:value-of select="IsSummaryInd"/>
						</xsl:with-param>
					</xsl:call-template>
				</xsl:when>
				<xsl:when test="ItemDefinition/ItemTypeCd[. = 'ComputerEquip']">
					<xsl:call-template name="Insert_PropLost">
						...
						<xsl:with-param name="Display_Value">
							<xsl:value-of select="ItemDefinition/ItemTypeCd[. = 'ComputerEquip']"/>
							<xsl:value-of select="IsSummaryInd"/>
						</xsl:with-param>
					</xsl:call-template>
				</xsl:when>
				<xsl:when test="ItemDefinition/ItemTypeCd[. = 'Furs']">
					<xsl:call-template name="Insert_PropLost">
						...
						<xsl:with-param name="Display_Value">
							<xsl:value-of select="ItemDefinition/ItemTypeCd[. = 'Furs']"/>
							<xsl:value-of select="IsSummaryInd"/>
						</xsl:with-param>
					</xsl:call-template>
				</xsl:when>
				<xsl:when test="ItemDefinition/ItemTypeCd[. = 'Guns']">
					<xsl:call-template name="Insert_PropLost">
						...
						<xsl:with-param name="Display_Value">
							<xsl:value-of select="ItemDefinition/ItemTypeCd[. = 'Guns']"/>
							<xsl:value-of select="IsSummaryInd"/>
						</xsl:with-param>
					</xsl:call-template>
				</xsl:when>
				<xsl:when test="ItemDefinition/ItemTypeCd[. = 'Jewelry']">
					<xsl:call-template name="Insert_PropLost">
						...
						<xsl:with-param name="Display_Value">
							<xsl:value-of select="ItemDefinition/ItemTypeCd[. = 'Jewelry']"/>
							<xsl:value-of select="IsSummaryInd"/>
						</xsl:with-param>
					</xsl:call-template>
				</xsl:when>
				<xsl:when test="ItemDefinition/ItemTypeCd[. = 'Silverware']">
					<xsl:call-template name="Insert_PropLost">
						...
						<xsl:with-param name="Display_Value">
							<xsl:value-of select="ItemDefinition/ItemTypeCd[. = 'Silverware']"/>
							<xsl:value-of select="IsSummaryInd"/>
						</xsl:with-param>
					</xsl:call-template>
				</xsl:when>
				<xsl:when test="ItemDefinition/ItemTypeCd[. = 'SportsEquip']">
					<xsl:call-template name="Insert_PropLost">
						...
						<xsl:with-param name="Display_Value">
							<xsl:value-of select="ItemDefinition/ItemTypeCd[. = 'SportsEquip']"/>
							<xsl:value-of select="IsSummaryInd"/>
						</xsl:with-param>
					</xsl:call-template>
				</xsl:when>
				<xsl:when test="ItemDefinition/ItemTypeCd[. = 'Tools']">
					<xsl:call-template name="Insert_PropLost">
						...
						<xsl:with-param name="Display_Value">
							<xsl:value-of select="ItemDefinition/ItemTypeCd[. = 'Tools']"/>
							<xsl:value-of select="IsSummaryInd"/>
						</xsl:with-param>
					</xsl:call-template>
				</xsl:when>
				<xsl:when test="ItemDefinition/ItemTypeCd[. = 'OfficeEquip']">
					<xsl:call-template name="Insert_PropLost">
						...
						<xsl:with-param name="Display_Value">
							<xsl:value-of select="ItemDefinition/ItemTypeCd[. = 'OfficeEquip']"/>
							<xsl:value-of select="IsSummaryInd"/>
						</xsl:with-param>
					</xsl:call-template>
				</xsl:when>
				<xsl:when test="ItemDefinition/ItemTypeCd[. = 'Other']">
					<xsl:call-template name="Insert_PropLost">
						...
						<xsl:with-param name="Display_Value">
							<xsl:value-of select="ItemDefinition/ItemTypeCd[. = 'Other']"/>
							<xsl:value-of select="IsSummaryInd"/>
						</xsl:with-param>
					</xsl:call-template>
				</xsl:when>
		...
		-->
		<xsl:variable name="PropTheftTypeCd" select="$PropLossNode/com.iso_ContentTheftInd"/>
		<xsl:call-template name="Insert_Data_Using_Code_List">
			<xsl:with-param name="Data_Name">Content Theft Type</xsl:with-param>
			<xsl:with-param name="Data_Code">
				<xsl:value-of select="$PropTheftTypeCd"/>
			</xsl:with-param>
			<xsl:with-param name="Data_Code_Value">
				<xsl:value-of select="$xmlCodeList/ClaimsearchCodes/PropTheftTypeCds/*[@code=$PropTheftTypeCd]"/>
			</xsl:with-param>
		</xsl:call-template>
...
-->
	<xsl:template name="Display_Water_Mobile_Property">
		...
		<xsl:if test="count($MobileYear) &gt; 0 or count($MobileMake) &gt; 0 or count($MobileModel) &gt; 0 or count($MobileVehStyle) &gt; 0 or count($MobileVIN) &gt; 0 or count($MobileEngSerial) &gt; 0 or count($MobileChasisNum) &gt; 0 or count($MobileTransNum) &gt; 0">
			...
			<xsl:if test="count($PropLossNode/ItemInfo/ItemDefinition[ItemTypeCd = 'MoblEquip']/Manufacturer) &gt; 0">
				<xsl:call-template name="Insert_Data">
			...
			<xsl:if test="count($PropLossNode/ItemInfo/ItemDefinition[ItemTypeCd = 'MoblEquip']/ManufacturerCd) &gt; 0">
				<xsl:call-template name="Insert_Data">
					<xsl:with-param name="Data_Name">Make</xsl:with-param>
					<xsl:with-param name="Data_Value">
						<xsl:value-of select="$PropLossNode/ItemInfo/ItemDefinition[ItemTypeCd = 'MoblEquip']/ManufacturerCd"/>
					</xsl:with-param>
				</xsl:call-template>
			</xsl:if>
			<xsl:if test="count($PropLossNode/ItemInfo/ItemDefinition[ItemTypeCd = 'MoblEquip']/Model) &gt; 0">
				<xsl:call-template name="Insert_Data">
			...
			<xsl:if test="count($PropLossNode/ItemInfo/ItemDefinition[ItemTypeCd = 'MoblEquip']/ModelCd) &gt; 0">
				<xsl:call-template name="Insert_Data">
					<xsl:with-param name="Data_Name">Model</xsl:with-param>
					<xsl:with-param name="Data_Value">
						<xsl:value-of select="$PropLossNode/ItemInfo/ItemDefinition[ItemTypeCd = 'MoblEquip']/ModelCd"/>
					</xsl:with-param>
				</xsl:call-template>
			</xsl:if>
			<xsl:call-template name="Insert_Data">
		...
		<xsl:if test="count($TheftType) &gt; 0 or  count($MP03RecDt) &gt; 0 or count($MP03RecAgency) &gt; 0 or count($MP03RecAgencyCity) &gt; 0 or count($MP03RecAgencySt) &gt; 0 or count($MP03RecAgencyCountry) &gt; 0 or count($Rec_PhoneNum) &gt; 0 or count($RecoveryCond) &gt; 0 or count($RecoveryClass) &gt; 0">
			...
			<xsl:choose>
				<xsl:when test="$InvestigationNode/RecoveryInfo/RecoveryStatusCd[@codelistref ='RecoveryConditionCdList']">
			...
			<!-- Recovery classification code for WTX only -->
			<xsl:choose>
				<xsl:when test="$InvestigationNode/RecoveryInfo/RecoveryStatusCd[@codelistref ='RecoveryClassificationCdList']">
					<xsl:variable name="RecoveryClassifWTX" select="$InvestigationNode/RecoveryInfo/RecoveryStatusCd[@codelistref ='RecoveryClassificationCdList']"/>
					<xsl:call-template name="Insert_Data_Using_Code_List">
						<xsl:with-param name="Data_Name">Recovery Classification</xsl:with-param>
						<xsl:with-param name="Data_Code">
							<xsl:value-of select="$RecoveryClassifWTX"/>
						</xsl:with-param>
						<xsl:with-param name="Data_Code_Value">
							<xsl:value-of select="$xmlCodeList/ClaimsearchCodes/RecoveryClassificationCds/*[@code=$RecoveryClassifWTX]"/>
						</xsl:with-param>
					</xsl:call-template>
				</xsl:when>
				<xsl:otherwise>
			...
			<xsl:if test="$InvestigationNode/RecoveryInfo/RecoveryStatusCd[@codelistref ='RecoveryClassificationCdList']">
				<xsl:variable name="RecoveryClassifWTX" select="$InvestigationNode/RecoveryInfo/RecoveryStatusCd[@codelistref ='RecoveryClassificationCdList']"/>
				<xsl:call-template name="Insert_Data_Using_Code_List">
					<xsl:with-param name="Data_Name">Recovery Classification</xsl:with-param>
					<xsl:with-param name="Data_Code">
	...
	<xsl:template name="Display_Water_Mobile_Salvage">
		...
		<xsl:if test="count($MP08SalDt) &gt; 0">
			...
			-->
				...
				<xsl:if test="string-length(normalize-space($PropLossNode/Watercraft/ItemDefinition[ItemTypeCd = 'Watercraft']/SerialIdNumber)) &gt; 0">
					<xsl:call-template name="Insert_Data">
						<xsl:with-param name="Data_Name">HIN</xsl:with-param>
						<xsl:with-param name="Data_Value">
							<xsl:value-of select="$PropLossNode/Watercraft/ItemDefinition[ItemTypeCd = 'Watercraft']/SerialIdNumber"/>
				...
				<xsl:if test="string-length(normalize-space($PropLossNode/ItemInfo/ItemDefinition[ItemTypeCd = 'MoblEquip']/SerialIdNumber)) &gt; 0">
					<xsl:call-template name="Insert_Data">
						<xsl:with-param name="Data_Name">VIN</xsl:with-param>
						<xsl:with-param name="Data_Value">
							<xsl:value-of select="$PropLossNode/ItemInfo/ItemDefinition[ItemTypeCd = 'MoblEquip']/SerialIdNumber"/>
			...
			<xsl:call-template name="Insert_Data">
				...
				<xsl:with-param name="Data_Value">
					<xsl:if test="$OwnerRetainSal1=0 or $OwnerRetainSal1='N'">NO</xsl:if>
					<xsl:if test="$OwnerRetainSal1=1 or $OwnerRetainSal1='Y'">YES</xsl:if>
				</xsl:with-param>
			</xsl:call-template>
			<xsl:choose>
...
-->
	<xsl:template name="Display_Vehicle_Info">
		...
		<xsl:variable name="MV01NMVTISChk" select="$InvestigationNode/com.iso_NMVTISCheckInd"/>
		<xsl:if test="string-length(normalize-space($MV01NMVTISChk)) &gt; 0">
			<xsl:call-template name="Insert_Data">
				<xsl:with-param name="Data_Name">NMVTIS/Check Digit Validation</xsl:with-param>
				<xsl:with-param name="Data_Value">
					<xsl:if test="$MV01NMVTISChk='E'">VIN PASSED CHECK DIGIT</xsl:if>
				</xsl:with-param>
			</xsl:call-template>
		</xsl:if>
		<xsl:call-template name="Insert_Data">
		...
		<xsl:call-template name="Insert_Data">
			...
			<xsl:with-param name="Data_Value">
				<!--<xsl:value-of select="$ClaimsPartyNode/ClaimsPartyInfo/SuitFiledInd"/>-->
				<xsl:if test="$SuiteInd=0 or $SuiteInd='N'">NO</xsl:if>
				<xsl:if test="$SuiteInd=1 or $SuiteInd='Y'">YES</xsl:if>
			</xsl:with-param>
		</xsl:call-template>
		...
		<xsl:choose>
			<xsl:when test="$InvestigationNode/RecoveryInfo[@ItemRef = $MV01Id]/RecoveryStatusCd[@codelistref ='RecoveryConditionCdList']">
		...
		<!--</xsl:if>-->
		<xsl:choose>
			<xsl:when test="$InvestigationNode/RecoveryInfo[@ItemRef = $MV01Id]/RecoveryStatusCd[@codelistref ='RecoveryClassificationCdList']">
				<xsl:variable name="RecoveryClassifWTX" select="$InvestigationNode/RecoveryInfo[@ItemRef = $MV01Id]/RecoveryStatusCd[@codelistref ='RecoveryClassificationCdList']"/>
				<xsl:call-template name="Insert_Data_Using_Code_List">
					<xsl:with-param name="Data_Name">Recovery Classification</xsl:with-param>
					<xsl:with-param name="Data_Code">
						<xsl:value-of select="$RecoveryClassifWTX"/>
	...
	<xsl:template name="Display_Vehicle_Salvage">
		...
		-->
			...
			<xsl:call-template name="Insert_Data">
				<xsl:with-param name="Data_Name">Owner Retaining Salvage?</xsl:with-param>
				<xsl:with-param name="Data_Value">
					<xsl:if test="$OwnerRetainSal=0 or $OwnerRetainSal='N'">NO</xsl:if>
					<xsl:if test="$OwnerRetainSal=1 or $OwnerRetainSal='Y'">YES</xsl:if>
				</xsl:with-param>
			</xsl:call-template>
			<!--
			<xsl:if test="string-length(normalize-space($BuyerNode)) &gt; 0">
